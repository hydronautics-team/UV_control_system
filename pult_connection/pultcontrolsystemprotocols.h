...
namespace ControlSystem {
    ...
    public:
        explicit PC_Protocol(QHostAddress _receiverIP, int _receiverPort, QHostAddress _senderIP, \
            ...
            qDebug()<<"PC_Protocol constructor!!! 111111111";
        ...
        explicit PC_Protocol(const QString &config = "protocols.conf",
            ...
            qDebug()<<"PC_Protocol constructor!!! 222222";
    ...
    public slots :
        ...
        void sendData() {
            ...
            qDebug() << "imuData.ax " << udpProtocol->send_data.imuData.ax << " sent";
        }
