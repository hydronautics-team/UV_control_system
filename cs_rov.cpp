...
//                if (K[114]!=0) {
//                        X[203][0] = X[203][1]+t_shag*0.001*(1/K[114])*(X[202][0]*K[115]-X[203][1]);
//                        X[203][1]= X[203][0];//запоминаем значение с этого шага для апериодич. звена
//                }
//                else {
//                        X[203][0] = X[202][0]*K[114];
//                        X[203][1] = X[203][0];
//                }

//                X[204][0] = K[133]*X[91][0];
//                if (K[112]!=0) {
//                    X[206][0] = X[206][1]+ t_shag*0.001*(1/K[112])*(X[205][0]*K[111]-X[206][1]);
//                    X[206][1]= X[206][0];//запоминаем значение с этого шага для апериодич. звена
//                }
//                else {
//                    X[206][0] = X[205][0]*K[111];
//                    X[206][1] = X[206][0];
//                }
//                //X[208][0]= (K[113]*(X[206][0]-X[208][1])/(t_shag*0.001));
//                //X[208][1]= X[208][0];//запоминаем значение с этого шага для дифференцирования
//                X[210][0]= X[206][0];
